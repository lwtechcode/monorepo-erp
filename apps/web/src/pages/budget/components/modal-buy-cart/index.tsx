...
import { addSaleBudget } from '../../services';
...
export function ModalBuyCart({
  ...
  function applyDiscountAndAdditions(
    ...
    setFieldValue ? setFieldValue('additions', valueAddition.toFixed(2)) : null;
    ...
    mutateAddSale(
      {
        ...
        discount_value: Number(data?.discount as string),
                ...
                <Grid.Row gutter={[12, 4]} className="mt-4">
                  ...
                  <Grid.Col span={8}>
                    <Statistic
                      ...
                      title="Acréscimos"
                      value={formatMoney(values?.additions as string)}
                    />
                  </Grid.Col>
